/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 219c2359f7f89d731612599c90e22b09)
// Runtime types generated with workerd@1.20260131.0 2026-01-31 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ITickWebSocketManager";
	}
	interface Env {
		KAFKA_REST_URL: "https://default-boris1993-4195.k.aivencloud.com:22572";
		INFLUX_DB_HOST: "https://us-east-1-1.aws.cloud2.influxdata.com";
		INFLUX_DB_BUCKET: "precious-metal-quote";
		ITICK_API_TOKEN: string;
		AIVEN_KAFKA_USERNAME: string;
		AIVEN_KAFKA_PASSWORD: string;
		INFLUX_DB_TOKEN: string;
		PRECIOUS_METAL_QUOTE_LISTENER_DO: DurableObjectNamespace<import("./src/index").ITickWebSocketManager>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KAFKA_REST_URL" | "INFLUX_DB_HOST" | "INFLUX_DB_BUCKET" | "ITICK_API_TOKEN" | "AIVEN_KAFKA_USERNAME" | "AIVEN_KAFKA_PASSWORD" | "INFLUX_DB_TOKEN">> {}
}
